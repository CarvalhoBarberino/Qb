...
public class Main{
	public static void main(String args[]){
		...
		a.elemento[1][1] = new Complexo(1, 0);
		a.elemento[1][2] = new Complexo(0, 0);
		a.elemento[1][3] = new Complexo(2, 0);
		a.elemento[2][0] = new Complexo(-5, 0);
		a.elemento[2][1] = new Complexo(1, 0);
		a.elemento[2][2] = new Complexo(-2, 0);
		a.elemento[2][3] = new Complexo(0, 0);
